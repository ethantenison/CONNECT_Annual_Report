...
layout$x[layout$name == "Literacy Coalition"] <- 0.474498359        	
layout$y[layout$name == "Literacy Coalition"] <- -0.88025639
layout$x[layout$name == "Hays Caldwell Women's Center"] <- 0.241652008        	
layout$y[layout$name == "Hays Caldwell Women's Center"] <- -0.97036298

layout$x[layout$name == "PelotonU"] <- 0.265864481        	
layout$y[layout$name == "PelotonU"] <- -0.96401041
layout$x[layout$name == "LifeWorks"] <- -0.056293600        	
layout$y[layout$name == "LifeWorks"] <- -0.99841426
